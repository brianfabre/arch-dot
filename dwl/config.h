...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ NULL,       0.75, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const Key keys[] = {
	...
	// { MODKEY|MSHIFT,       XKB_KEY_H,          swapdir,        {.ui = 0} },
	// { MODKEY|MSHIFT,       XKB_KEY_L,          swapdir,        {.ui = 1} },
	// { MODKEY|MSHIFT,       XKB_KEY_K,          swapdir,        {.ui = 2} },
	// { MODKEY|MSHIFT,       XKB_KEY_J,          swapdir,        {.ui = 3} },
