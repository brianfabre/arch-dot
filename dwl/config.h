...
static const Key keys[] = {
    ...
    { HYPER,               XKB_KEY_7,          spawn,          SHCMD("~/.config/utils/scripts/temp_down.sh") },
    { HYPER,               XKB_KEY_8,          spawn,          SHCMD("~/.config/utils/scripts/temp_up.sh") },
    { HYPER,               XKB_KEY_9,          spawn,          SHCMD("~/.config/utils/scripts/bright_down.sh") },
    { HYPER,               XKB_KEY_0,          spawn,          SHCMD("~/.config/utils/scripts/bright_up.sh") },
    { HYPER,               XKB_KEY_minus,      spawn,          SHCMD("~/.config/utils/scripts/vol_down.sh") },
    { HYPER,               XKB_KEY_equal,      spawn,          SHCMD("~/.config/utils/scripts/vol_up.sh") },
    { HYPER,               XKB_KEY_backslash,  spawn,          SHCMD("~/.config/utils/scripts/reset_gamma.sh") },
